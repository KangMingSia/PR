codeunit 27003013 "Approvals Management-IBIZRFQ"
{
    ...
    begin
        ...
        with PurchaseHeader do begin
            ...
            if TemplateRec.FIND('-') then begin
                ...
                case MessageType of
                    MessageType::AutomaticPrePayment:
                        if lTestPurchasePrepayment(PurchaseHeader) then
                            MESSAGE(
                              UnpostedPrepaymentExistsMsg,
                              STRSUBSTNO(Text128, "Document Type", "No."),
                              "Document Type",
    ...
    procedure lTestPurchasePrepayment(PurchaseHeader: Record "Purchase Header"): Boolean;
    var
        PurchaseLines: Record "Purchase Line";
    begin
        ...
        with ApprovalEntry do begin
            ...
            if DocReleased then begin
                ...
                if PurchHeader."Document Type" = PurchHeader."Document Type"::Order then
                    if lTestPurchasePrepayment(PurchHeader) then
                        MessageID := MessageID::AutomaticPrePayment
                    else
